...
<div class="container mt-4">
    <div style="max-width: 800px; margin: 0 auto;">
        <h1>About GroceryKing</h1>
        
        <div class="card mt-4">
            <div class="card-body">
                <h2>Our Mission</h2>
                <p>At GroceryKing, we're dedicated to bringing fresh, high-quality groceries directly to your doorstep. We believe that everyone deserves access to fresh, healthy products at affordable prices.</p>
                ...
                <p>
                    <strong>Email:</strong> info@GroceryKing.com<br>
                    <strong>Phone:</strong> 1-800-GroceryKing<br>
